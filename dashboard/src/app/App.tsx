      ...
      <div className="grid grid-cols-12 gap-3">
        ...
        <div className="col-span-7 bg-card border border-border rounded-lg p-4">
          ...
          <ResponsiveContainer width="100%" height={160}>
            <LineChart data={systemOverviewData} margin={{ top: 5, right: 5, bottom: 0, left: -20 }}>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.05)" />
              <XAxis dataKey="time" tick={{ fontSize: 9, fill: "#64748b" }} tickLine={false} axisLine={false} />
              <YAxis tick={{ fontSize: 9, fill: "#64748b" }} tickLine={false} axisLine={false} />
              <Tooltip content={<CustomTooltip />} />
              <Legend wrapperStyle={{ fontSize: "10px", paddingTop: "8px" }} />
              <Line type="monotone" dataKey="online" stroke="#10b981" strokeWidth={1.5} dot={false} name="Online" />
              <Line type="monotone" dataKey="offline" stroke="#f59e0b" strokeWidth={1.5} dot={false} name="Offline" />
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="relative" style={{ width: 130, height: 130 }}>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <span className="text-[22px] font-bold text-foreground leading-none">128</span>
